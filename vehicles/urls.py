...
from .views import DashboardView, VehicleListView, VehicleTypeListView, VehicleStatusListView,UsersListView,ServicesListView,VehicleDetailsView,NewServiceView
